...
# Added for logging
parser.add_argument("--tblog", type=int, default=1,
                    help="tensorboard logging: True or False")
...
def main(args):
    ...
    wandb.init(project='babyAI-CW', entity='graceduansu')
    config = wandb.config
    ...
    if args.tblog:
        ...
        print('!!!tensorboard initiated: ', utils.get_log_dir(args.model))
